...
const ICOABI = require('./abis/ICO.json');
...
contract("ICO", async (accounts) => {
  ...
  beforeEach(async () => {
    // Create Instances
    this.ICOInstance = await ICO.new({ from: deployer });
    // Get Current Block
    ...
    // Create Contracts
    this.ICO = await new web3.eth.Contract(ICOABI.abi, this.ICOInstance.address);
  ...
  describe('Base Token Test', async() => {
    ...
    it ('Check Initial Base Token', async() => {
      ...
      const baseTokenAddress = await callMethod(this.ICO.methods.getBaseToken, []);
    ...
    it ('Check Set Base Token', async() => {
      ...
      await this.ICOInstance.setBaseToken(baseToken);
      // Get Base Token Address
      const baseTokenAddress = await callMethod(this.ICO.methods.getBaseToken, []);
      // Check Base Token Address
  ...
  describe('Sale Token Test', async() => {
    ...
    it ('Check Initial Sale Token', async() => {
      ...
      const saleTokenAddress = await callMethod(this.ICO.methods.getSaleToken, []);
    ...
    it ('Check Set Sale Token', async() => {
      ...
      await this.ICOInstance.setSaleToken(saleToken);
      // Get Sale Token Address
      const saleTokenAddress = await callMethod(this.ICO.methods.getSaleToken, []);
      // Check Sale Token Address
  ...
  describe('Sale Rate Test', async() => {
    ...
    it ('Check Initial Sale Rate', async() => {
      // Get Sale Rate
      const saleRate = await callMethod(this.ICO.methods.getSaleRate, []);
      // Check Sale Rate
    ...
    it ('Check Set Sale Rate', async() => {
      // Set Sale Rate
      await this.ICOInstance.setSaleRate(newSaleRate);
      // Get Sale Rate
      const saleRate = await callMethod(this.ICO.methods.getSaleRate, []);
      // Check Sale Rate
  ...
  describe('Is Sale Test', async() => {
    ...
    it ('Check Initial IsSale', async() => {
      // Get IsSale
      const isSale = await callMethod(this.ICO.methods.getIsSale, []);
      // Check IsSale
    ...
    it ('Check Set IsSale', async() => {
      // Set Is Sale
      await this.ICOInstance.setIsSale(saleFlag);
      // Get IsSale
      const isSale = await callMethod(this.ICO.methods.getIsSale, []);
      // Check Is Sale
  ...
  describe('Start Time Test', async() => {
    ...
    it ('Check Initial Start Time', async() => {
      // Get StartTime
      const startTime = await callMethod(this.ICO.methods.getStartTime, []);
      // Check StartTime
    ...
    it ('Check Set Start Time', async() => {
      // Set Start Time
      await this.ICOInstance.setStartTime(newStartTime);
      // Get Start Time
      const startTime = await callMethod(this.ICO.methods.getStartTime, []);
      // Check Start Time
  ...
  describe('End Time Test', async() => {
    ...
    it ('Check Initial End Time', async() => {
      // Get EndTime
      const endTime = await callMethod(this.ICO.methods.getEndTime, []);
      // Check EndTime
    ...
    it ('Should Be More than First Time', async() => {
      // Set Start Time
      await this.ICOInstance.setStartTime(newEndTime);
      // Set End Time
      await truffleAssert.reverts(this.ICOInstance.setEndTime(newEndTime), "EndTime should be over than startTime");
    });

    it ('Check Set End Time', async() => {
      // Set End Time
      await this.ICOInstance.setEndTime(newEndTime);
      // Get End Time
      const endTime = await callMethod(this.ICO.methods.getEndTime, []);
      // Check End Time
  ...
  describe('Min Base Amount Test', async() => {
    ...
    it ('Check Initial Min Base Amount', async() => {
      // Get Min Base Amount
      const minBaseAmount = await callMethod(this.ICO.methods.getMinBaseAmount, []);
    ...
    it ('Check Set Min Base Amouont', async() => {
      // Set Min Base Amount
      await this.ICOInstance.setMinBaseAmount(newMinBaseAmount);
      // Get Min Base Amount
      const minBaseAmount = await callMethod(this.ICO.methods.getMinBaseAmount, []);
      // Check Min Base Amount
  ...
  describe('Max Base Amount Test', async() => {
    ...
    it ('Check Initial Max Base Amount', async() => {
      // Get Max Base Amount
      const maxBaseAmount = await callMethod(this.ICO.methods.getMaxBaseAmount, []);
    ...
    it ('Should Be More than Min Base Amount', async() => {
      // Set Min Base Amount
      await this.ICOInstance.setMinBaseAmount(newMaxBaseAmount);
      // Set Max Base Amount
      await truffleAssert.reverts(this.ICOInstance.setMaxBaseAmount(newMaxBaseAmount), "MaxBaseAmount should be over than minBaseAmount");
    });

    it ('Check Set Max Base Amount', async() => {
      // Set Max Base Amount
      await this.ICOInstance.setMaxBaseAmount(newMaxBaseAmount);
      // Get Max Base Amount
      const maxBaseAmount = await callMethod(this.ICO.methods.getMaxBaseAmount, []);
      // Check Max Base Amount
  ...
  describe('Limit Base Amount Test', async() => {
    ...
    it ('Check Initial Limit Base Amount', async() => {
      ...
      const limitBaseAmount = await callMethod(this.ICO.methods.getLimitBaseAmount, []);
    ...
    it ('Check Set Limit Base Amouont', async() => {
      ...
      await this.ICOInstance.setLimitBaseAmount(newLimitBaseAmount);
      // Get Limit Base Amount
      const limitBaseAmount = await callMethod(this.ICO.methods.getLimitBaseAmount, []);
      // Check Limit Base Amount
  ...
  describe('Allocation Amount Test', async() => {
    ...
    beforeEach(async() => {
      ...
      // Set Sale Token
      await this.ICOInstance.setSaleToken(
    ...
    it ('Check Owner', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.allocationAmount(allocationAmount, { from: accounts[1] }),
    ...
    it ('Check allocationAmount more than balance of Owner', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.allocationAmount(maxAllocationAmount.toFixed()),
    ...
    it ('Check allocationAmount', async() => {
      // Approve the Amount
      await this.saleTokenInstance.approve(this.ICOInstance.address, allocationAmount, { from: deployer });
      // Call allocationAmount
      await this.ICOInstance.allocationAmount(allocationAmount, { from: deployer });
      // Get Balance of ICO with saleToken
      const balanceSakeToken = await callMethod(
        this.saleToken.methods.balanceOf,
        [this.ICOInstance.address]
      );
      // Check Balance
  ...
  describe('Burn Base Token Test', async() => {
    ...
    beforeEach(async() => {
      // Set Base Token
      await this.ICOInstance.setBaseToken(
    ...
    it ('Check Owner', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.burnBaseToken(baseAmount, { from: accounts[1] }),
        "Ownable: caller is not the owner"
      );
    });
    ...
    it ('Check baseAmount more than balance of Contract', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.burnBaseToken(maxBurnAmount.toFixed()),
    ...
    it ('Check burnBaseToken', async() => {
      ...
      await this.ICOInstance.burnBaseToken(burnAmount);
  ...
  describe('Withdraw Base Token Test', async() => {
    ...
    it ('Check Owner', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.withdrawBaseToken(
          accounts[2],
    ...
    it ('Check withdrawBaseToken', async() => {
      ...
      await this.ICOInstance.withdrawBaseToken(
        accounts[1],
        withdrawAmount
      );
  ...
  describe('Withdraw Sale Token Test', async() => {
    ...
    it ('Check Owner', async() => {
      ...
      await truffleAssert.reverts(
        this.ICOInstance.withdrawSaleToken(
          accounts[2],
          withdrawAmount.toFixed(),
          {
            from: accounts[1]
    ...
    it ('Check withdrawSaleToken', async() => {
      ...
      await this.ICOInstance.withdrawSaleToken(
        accounts[1],
        withdrawAmount
      );
  ...
  describe('Swipe IWO Over Test', async() => {
    beforeEach(async() => {
      // Set Base Token Address
      await this.ICOInstance.setBaseToken(this.baseTokenInstance.address);
      // Set Sale Token Address
      await this.ICOInstance.setSaleToken(this.saleTokenInstance.address);
    });

    it ('Check IWO IsSale', async() => {
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(defaultValue, { from: accounts[1] }),
        "ICO is sale over"
      );
    });
    ...
    it ('Check IWO Start Time', async() => {
      ...
      // Set IWO IsSale
      await this.ICOInstance.setIsSale(true);
      // Set IWO Start Time
      await this.ICOInstance.setStartTime(startTime);
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(defaultValue, { from: accounts[1] }),
    ...
    it ('Check IWO End Time', async() => {
      ...
      await this.ICOInstance.setStartTime(startTime);
      // Set IWO End Time
      await this.ICOInstance.setEndTime(endTime);
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(defaultValue, { from: accounts[1] }),
        "ICO is already finished"
      );
    });
    ...
    it ('Check IWO Limit Base Amount', async() => {
      ...
      await this.ICOInstance.setEndTime(endTime);
      // Set Limit Base Amount
      await this.ICOInstance.setLimitBaseAmount(limitBaseAmount.toFixed());
    ...
    it ('Check IWO Purchase Allowed', async() => {
      ...
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(purchaseAmount.toFixed(), { from: accounts[1] }),
    ...
    it ('Check IWO Purchase Max Allowance', async() => {
      ...
      await this.ICOInstance.setLimitBaseAmount(limitBaseAmount.toFixed());
      // Set White Status
      await this.ICOInstance.setWhiteStatus(
        [
          accounts[1]
        ],
        [
      ...
      // Get White Status
      const whiteStatus = await callMethod(this.ICO.methods.getWhiteStatus, [accounts[1]]);
      // Check White Status
  ...
  describe('Swipe IWO Purchase Test', async() => {
    ...
    beforeEach(async() => {
      ...
      await this.ICOInstance.setSaleToken(this.saleTokenInstance.address);    
      // Set Sale Rate
      await this.ICOInstance.setSaleRate(saleRate.toFixed());
      // Set IWO IsSale
      await this.ICOInstance.setIsSale(true);
      // Set IWO Start Time
      await this.ICOInstance.setStartTime(startTime);
      ...
      await this.ICOInstance.setEndTime(endTime);
      // Set Min Base Amount
      await this.ICOInstance.setMinBaseAmount(minBaseAmouont.toFixed());
      // Set Max Base Amount
      await this.ICOInstance.setMaxBaseAmount(maxBaseAmouont.toFixed());
      // Set Limit Base Amount
      await this.ICOInstance.setLimitBaseAmount(limitBaseAmount.toFixed());
      // Set White Status
      await this.ICOInstance.setWhiteStatus(
    ...
    it ('Check Purchase Min Amount', async() => {
      ...
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(purchaseAmount, { from: accounts[1] }),
    ...
    it ('Check Purchase Base Token With Single Account', async() => {
      ...
      await this.ICOInstance.purchaseSaleToken(purchaseBaseAmount.toFixed(), { from: accounts[1] });
      ...
      const contractBaseAmount = await callMethod(this.baseToken.methods.balanceOf, [this.ICOInstance.address]);
      assert.equal(contractBaseAmount, purchaseBaseAmount.toFixed());

      // Check Contract Sale Amount
      const contractSaleAmount =  await callMethod(this.saleToken.methods.balanceOf, [this.ICOInstance.address]);
    ...
    it ('Check Purchase Base Token With Multiple Accounts', async() => {
      ...
      let contractOldBaseAmount = await callMethod(this.baseToken.methods.balanceOf, [this.ICOInstance.address]);
      let contractOldSaleAmount =  await callMethod(this.saleToken.methods.balanceOf, [this.ICOInstance.address]);
      ...
      // Check Contract Base Amount
      let contractBaseAmount = await callMethod(this.baseToken.methods.balanceOf, [this.ICOInstance.address]);
      assert.equal(contractBaseAmount, (new BigNumber(contractOldBaseAmount)).plus(purchaseBaseAmount).toFixed());

      // Check Contract Sale Amount
      let contractSaleAmount =  await callMethod(this.saleToken.methods.balanceOf, [this.ICOInstance.address]);
      ...
      // Get Contract Old Amounts
      contractOldBaseAmount = await callMethod(this.baseToken.methods.balanceOf, [this.ICOInstance.address]);
      contractOldSaleAmount =  await callMethod(this.saleToken.methods.balanceOf, [this.ICOInstance.address]);
      ...
      await this.ICOInstance.purchaseSaleToken(purchaseBaseAmount.toFixed(), { from: accounts[2] });
      ...
      // Check Contract Base Amount
      contractBaseAmount = await callMethod(this.baseToken.methods.balanceOf, [this.ICOInstance.address]);
      assert.equal(contractBaseAmount, (new BigNumber(contractOldBaseAmount)).plus(purchaseBaseAmount).toFixed());

      // Check Contract Sale Amount
      contractSaleAmount =  await callMethod(this.saleToken.methods.balanceOf, [this.ICOInstance.address]);
      assert.equal(contractSaleAmount, (new BigNumber(contractOldSaleAmount)).minus(purchaseSaleAmount).toFixed());
    });

    it ('Check Purchase Base Token Limit Base Token', async() => {
      // Increase Base Max Amount
      await this.ICOInstance.setMaxBaseAmount(limitBaseAmount.toFixed());
      await this.ICOInstance.setWhiteStatus(
        [accounts[1]],
        [
          {
      ...
      await this.ICOInstance.purchaseSaleToken(limitBaseAmount.toFixed(), { from: accounts[1] });
      ...
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(purchaseBaseAmount, { from: accounts[2] }),
    ...
    it ('Check Double Purchase Base Token Max Amount', async() => {
      ...
      await this.ICOInstance.purchaseSaleToken(maxBaseAmouont.toFixed(), { from: accounts[1] });
      ...
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(purchaseBaseAmount, { from: accounts[1] }),
        "You can not purchase more than maxAllowance"
      );
    });
    ...
    it ('Check Double Purchase Base Token Max Allowance - Successful Case', async() => {
      ...
      await this.ICOInstance.purchaseSaleToken(purchaseBase2Amount.toFixed(), { from: accounts[1] });
    ...
    it ('Check Double Purchase Base Token Max Allowance - Failed Case', async() => {
      ...
      // Call purchaseSaleToken
      await truffleAssert.reverts(
        this.ICOInstance.purchaseSaleToken(purchaseBaseAmount.toFixed(), { from: accounts[2] }),
        "You can not purchase more than maxAllowance"
      );      
    });
  });
